...
function fHideCalendar(){
  VicPopCal.baseStyle.visibility = "hidden";
  for (i in goSelectTag)
  	goSelectTag[i].baseStyle.visibility = "visible";
  ...
  with (document.all.tags("SELECT")){
 	for (i=0; i<length; i++)
 		if ((item(i).Victor!="Won")&&fTagInBound(item(i))){
 			item(i).baseStyle.visibility = "hidden";
...
write("<B style='cursor:hand;' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.baseStyle.color=gcToggle' onMouseOut='this.baseStyle.color=0'>今天："+giYear+"年"+giMonth+"月"+giDay+"日</B>");
write("</TD></TR>");
write("</TABLE></Div>");
