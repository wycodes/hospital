      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD vAlign=top><TABLE height=24 cellSpacing=0 cellPadding=0 width="100%" 
              border=0><TBODY>
              <TR 
              style="BACKGROUND: url(../../../../../resources/static/qtimages/zjgdj_sy_15.gif) repeat-x 50% top">
                <TD width=13></TD>
                <TD 
                style="FONT-SIZE: 14px; COLOR: #fff; BACKGROUND-REPEAT: no-repeat" 
                align=middle width=89 
                  background=../../../../../resources/static/qtimages/zjgdj_sy_16.jpg><STRONG><a href="indexmethod!xinwenlist" ><font class="STYLE1">医院新闻</font></a></STRONG></TD>
                <TD width=27></TD>
              ...
              <TR>
                ...
                vAlign=top class="newsline"><table class="newsline" cellspacing="0" cellpadding="0" width="98%" 
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td width="4%" height="28" align="center" ><img src="../../../../../resources/static/qtimages/1011211706367381564.gif" width="3" height="5"></td>
          ...
          <TD vAlign=top>
            <TABLE height=27 cellSpacing=0 cellPadding=0 width="100%"
              ...
              <TR>
                ...
                background=../../../../../resources/static/qtimages/zjgdj_79.gif><A href="indexmethod!doctorlist">更多&gt;&gt;</A></TD>
          ...
          <TR>
            ...
            <TD vAlign=top><TABLE height=27 cellSpacing=0 cellPadding=0 width="100%"
                ...
                align=absMiddle>&nbsp;系统简介</TD>
                    <TD style="PADDING-RIGHT: 1px" align=right 
                background=../../../../../resources/static/qtimages/zjgdj_79.gif><A href="yonghuzhucelist.jsp"></A></TD>
                    <TD width=7></TD>
                  </TR>
                </TBODY>
            </TABLE>
                              ...
                              <TD style="PADDING-TOP: 8px" align=middle><p align="center">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#529C33" style="border-collapse:collapse" class="newsline">
                                  <tr>
                                    ...
                                    本网站主要满足用户的在线预约挂号，请先注册登录后才预约挂号，预约检查！<br/>
                                    另外用户可以浏览医院新闻，科室介绍，可以给医生在线留言。    
                                    </td>
                                  </tr>
                                </table>
                             </TD>
